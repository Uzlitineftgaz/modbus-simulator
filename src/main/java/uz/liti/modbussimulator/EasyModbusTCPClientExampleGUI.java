...
public class EasyModbusTCPClientExampleGUI extends JFrame implements ReceiveDataChangedListener, SendDataChangedListener {
    JComboBox comboBox;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(this.jLabel5).addComponent(this.jLabel6).addComponent(this.jTextFieldStartingAddress, -2, 48, -2).addComponent(this.jTextFieldNumberOfValues, -2, 48, -2)).addGap(10).addComponent(this.jScrollPane1, -2, 0, 32767)).addGroup(jPanel1Layout.createSequentialGroup().addGap(0, 0, 32767).addComponent(this.jLabel2).addGap(73))).addContainerGap()));
        ...
        this.comboBox.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent arg0) {
                if ((String)arg0.getItem() == "Modbus TCP") {
                    EasyModbusTCPClientExampleGUI.this.modbusClient = new ModbusClient();
                    EasyModbusTCPClientExampleGUI.this.jpModbusTCP.setVisible(true);
                    EasyModbusTCPClientExampleGUI.this.jpModbusRTU.setVisible(false);
                } else {
                    EasyModbusTCPClientExampleGUI.this.modbusClient = new ModbusClient();
                    EasyModbusTCPClientExampleGUI.this.jpModbusRTU.setVisible(true);
                    EasyModbusTCPClientExampleGUI.this.jpModbusTCP.setVisible(false);
                }
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(EasyModbusTCPClientExampleGUI.class.getName()).log(Level.SEVERE, (String)null, var5);
        } catch (InstantiationException var6) {
            Logger.getLogger(EasyModbusTCPClientExampleGUI.class.getName()).log(Level.SEVERE, (String)null, var6);
        } catch (IllegalAccessException var7) {
            Logger.getLogger(EasyModbusTCPClientExampleGUI.class.getName()).log(Level.SEVERE, (String)null, var7);
        } catch (UnsupportedLookAndFeelException var8) {
            Logger.getLogger(EasyModbusTCPClientExampleGUI.class.getName()).log(Level.SEVERE, (String)null, var8);
        }
